/* =============================================================
   ...
   Restent NON vérifiés faute de source publique :
   • morningstar — laissé à null. La notation n'est accessible que
     par abonnement ; tant qu'elle vaut null, elle est retirée du
     score de sélection et le filtre « étoiles minimum » ne s'y
     applique pas. À saisir à la main depuis Quantalys/Morningstar.
...
const ETF_UNIVERS = [
  ...
  /* ---------------- ACTIONS MONDE ---------------- */
  {
    ...
    ter: 0.20, encours: 128942, morningstar: null, sri: 4, replication: 'Physique',
  ...
  },
  {
    ...
    ter: 0.38, encours: 6581, morningstar: null, sri: 4, replication: 'Synthétique',
  ...
  },
  {
    ...
    ter: 0.12, encours: 18006, morningstar: null, sri: 4, replication: 'Physique',
    devise: 'USD', hedge: false, capitalisation: true, isr: false,
  ...
  },
  {
    ...
    emetteur: 'BlackRock', classe: 'actions', poche: 'act-monde',
    ter: 0.20, encours: 7114, morningstar: null, sri: 4, replication: 'Physique',
  ...
  /* ---------------- ACTIONS ÉTATS-UNIS ---------------- */
  {
    ...
    ter: 0.07, encours: 135461, morningstar: null, sri: 4, replication: 'Physique',
    devise: 'USD', hedge: false, capitalisation: true, isr: false,
    pea: false, enveloppes: ['AV', 'CTO'], contratsAV: ['av-restreint'], verifie: false,
    donneesLe: '2026-08-15', donneesSource: 'justETF'
  },
  {
    ...
    ter: 0.12, encours: 1157, morningstar: null, sri: 4, replication: 'Synthétique',
    devise: 'EUR', hedge: false, capitalisation: true, isr: false,
    pea: true, enveloppes: ['AV', 'CTO', 'PEA'], contratsAV: ['av-standard'], verifie: false,
    donneesLe: '2026-08-15', donneesSource: 'justETF',
  ...
  },
  {
    ...
    ter: 0.15, encours: 3583, morningstar: null, sri: 4, replication: 'Synthétique',
    devise: 'USD', hedge: false, capitalisation: true, isr: false,
  ...
  /* ---------------- ACTIONS EUROPE ---------------- */
  {
    ...
    ter: 0.07, encours: 21197, morningstar: null, sri: 4, replication: 'Physique',
    devise: 'EUR', hedge: false, capitalisation: true, isr: false,
    pea: false, enveloppes: ['AV', 'CTO'], contratsAV: ['av-restreint'], verifie: false,
    donneesLe: '2026-08-15', donneesSource: 'justETF',
  ...
  },
  {
    ...
    ter: 0.12, encours: 16204, morningstar: null, sri: 4, replication: 'Physique',
    devise: 'EUR', hedge: false, capitalisation: true, isr: false,
    pea: false, enveloppes: ['AV', 'CTO'], contratsAV: ['av-standard'], verifie: false,
    donneesLe: '2026-08-15', donneesSource: 'justETF'
  },
  {
    ...
    emetteur: 'Amundi', classe: 'actions', poche: 'act-europe',
    ter: 0.25, encours: 3461, morningstar: null, sri: 4, replication: 'Physique',
  ...
  },
  {
    ...
    emetteur: 'Amundi', classe: 'actions', poche: 'act-europe',
    ter: 0.18, encours: 977, morningstar: null, sri: 4, replication: 'Physique',
    devise: 'EUR', hedge: false, capitalisation: true, isr: true,
    pea: false, enveloppes: ['AV', 'CTO'], contratsAV: ['av-large'], verifie: false,
    donneesLe: '2026-08-15', donneesSource: 'justETF',
  ...
  /* ---------------- ACTIONS JAPON ---------------- */
  {
    ...
    ter: 0.12, encours: 7204, morningstar: null, sri: 4, replication: 'Physique',
    devise: 'USD', hedge: false, capitalisation: true, isr: false,
    pea: false, enveloppes: ['AV', 'CTO'], contratsAV: ['av-standard'], verifie: false,
    donneesLe: '2026-08-15', donneesSource: 'justETF'
  },
  ...
  /* ---------------- ACTIONS ÉMERGENTS ---------------- */
  {
    ...
    ter: 0.18, encours: 37551, morningstar: null, sri: 4, replication: 'Physique',
    devise: 'USD', hedge: false, capitalisation: true, isr: false,
    pea: false, enveloppes: ['AV', 'CTO'], contratsAV: ['av-restreint'], verifie: false,
    donneesLe: '2026-08-15', donneesSource: 'justETF'
  },
  {
    ...
    ter: 0.30, encours: 853, morningstar: null, sri: 4, replication: 'Synthétique',
    devise: 'EUR', hedge: false, capitalisation: true, isr: true,
    pea: true, enveloppes: ['AV', 'CTO', 'PEA'], contratsAV: ['av-standard'], verifie: false,
    donneesLe: '2026-08-15', donneesSource: 'justETF'
  },
  ...
  /* ---------------- ACTIONS PETITES CAPITALISATIONS ---------------- */
  {
    ...
    ter: 0.35, encours: 7764, morningstar: null, sri: 5, replication: 'Physique',
    devise: 'USD', hedge: false, capitalisation: true, isr: false,
    pea: false, enveloppes: ['AV', 'CTO'], contratsAV: ['av-standard'], verifie: false,
    donneesLe: '2026-08-15', donneesSource: 'justETF'
  },
  {
    ...
    ter: 0.35, encours: 799, morningstar: null, sri: 5, replication: 'Synthétique',
    devise: 'EUR', hedge: false, capitalisation: true, isr: false,
    pea: false, enveloppes: ['AV', 'CTO'], contratsAV: ['av-large'], verifie: false,
    donneesLe: '2026-08-15', donneesSource: 'justETF',
  ...
  /* ---------------- ACTIONS TECHNOLOGIE ---------------- */
  {
    ...
    ter: 0.25, encours: 5617, morningstar: null, sri: 5, replication: 'Physique',
    devise: 'USD', hedge: false, capitalisation: true, isr: false,
    pea: false, enveloppes: ['AV', 'CTO'], contratsAV: ['av-standard'], verifie: false,
    donneesLe: '2026-08-15', donneesSource: 'justETF'
  },
  {
    ...
    ter: 0.30, encours: 24409, morningstar: null, sri: 5, replication: 'Physique',
    devise: 'USD', hedge: false, capitalisation: true, isr: false,
    pea: false, enveloppes: ['AV', 'CTO'], contratsAV: ['av-restreint'], verifie: false,
    donneesLe: '2026-08-15', donneesSource: 'justETF'
  },
  {
    ...
    ter: 0.30, encours: 1131, morningstar: null, sri: 5, replication: 'Synthétique',
    devise: 'EUR', hedge: false, capitalisation: true, isr: false,
  ...
  /* ---------------- ACTIONS FAIBLE VOLATILITÉ / QUALITÉ ---------------- */
  {
    ...
    ter: 0.30, encours: 2307, morningstar: null, sri: 4, replication: 'Physique',
    devise: 'USD', hedge: false, capitalisation: true, isr: false,
    pea: false, enveloppes: ['AV', 'CTO'], contratsAV: ['av-restreint'], verifie: false,
    donneesLe: '2026-08-15', donneesSource: 'justETF'
  },
  {
    ...
    emetteur: 'BlackRock', classe: 'actions', poche: 'act-min-vol',
    ter: 0.25, encours: 5367, morningstar: null, sri: 4, replication: 'Physique',
    devise: 'USD', hedge: false, capitalisation: true, isr: false,
    pea: false, enveloppes: ['AV', 'CTO'], contratsAV: ['av-standard'], verifie: false,
    donneesLe: '2026-08-15', donneesSource: 'justETF'
  },
  ...
  /* ---------------- OBLIGATIONS SOUVERAINES COURT TERME ---------------- */
  {
    ...
    ter: 0.15, encours: 1766, morningstar: null, sri: 2, replication: 'Physique',
    devise: 'EUR', hedge: false, capitalisation: false, isr: false,
    pea: false, enveloppes: ['AV', 'CTO'], contratsAV: ['av-restreint'], verifie: false,
    donneesLe: '2026-08-15', donneesSource: 'justETF'
  },
  {
    ...
    ter: 0.15, encours: 2209, morningstar: null, sri: 2, replication: 'Physique',
    devise: 'EUR', hedge: false, capitalisation: true, isr: false,
    pea: false, enveloppes: ['AV', 'CTO'], contratsAV: ['av-large'], verifie: false,
    donneesLe: '2026-08-15', donneesSource: 'justETF'
  },
  ...
  /* ---------------- OBLIGATIONS SOUVERAINES MOYEN-LONG TERME ---------------- */
  {
    ...
    ter: 0.07, encours: 5421, morningstar: null, sri: 3, replication: 'Physique',
    devise: 'EUR', hedge: false, capitalisation: false, isr: false,
    pea: false, enveloppes: ['AV', 'CTO'], contratsAV: ['av-restreint'], verifie: false,
    donneesLe: '2026-08-15', donneesSource: 'justETF'
  },
  {
    ...
    ter: 0.07, encours: 2269, morningstar: null, sri: 3, replication: 'Physique',
    devise: 'EUR', hedge: false, capitalisation: true, isr: false,
    pea: false, enveloppes: ['AV', 'CTO'], contratsAV: ['av-large'], verifie: false,
    donneesLe: '2026-08-15', donneesSource: 'justETF',
  ...
  /* ---------------- OBLIGATIONS D'ENTREPRISES INVESTMENT GRADE ---------------- */
  {
    ...
    ter: 0.09, encours: 8883, morningstar: null, sri: 3, replication: 'Physique',
    devise: 'EUR', hedge: false, capitalisation: false, isr: false,
    pea: false, enveloppes: ['AV', 'CTO'], contratsAV: ['av-restreint'], verifie: false,
    donneesLe: '2026-08-15', donneesSource: 'justETF'
  },
  {
    ...
    ter: 0.07, encours: 865, morningstar: null, sri: 3, replication: 'Physique',
    devise: 'EUR', hedge: false, capitalisation: true, isr: false,
    pea: false, enveloppes: ['AV', 'CTO'], contratsAV: ['av-standard'], verifie: false,
    donneesLe: '2026-08-15', donneesSource: 'justETF',
  ...
  /* ---------------- OBLIGATIONS HAUT RENDEMENT ---------------- */
  {
    ...
    ter: 0.50, encours: 5508, morningstar: null, sri: 3, replication: 'Physique',
    devise: 'EUR', hedge: false, capitalisation: false, isr: false,
    pea: false, enveloppes: ['AV', 'CTO'], contratsAV: ['av-standard'], verifie: false,
    donneesLe: '2026-08-15', donneesSource: 'justETF'
  },
  ...
  /* ---------------- OBLIGATIONS INDEXÉES INFLATION ---------------- */
  {
    ...
    ter: 0.09, encours: 1928, morningstar: null, sri: 3, replication: 'Physique',
    devise: 'EUR', hedge: false, capitalisation: true, isr: false,
    pea: false, enveloppes: ['AV', 'CTO'], contratsAV: ['av-restreint'], verifie: false,
    donneesLe: '2026-08-15', donneesSource: 'justETF',
  ...
  /* ---------------- DETTE ÉMERGENTE ---------------- */
  {
    ...
    ter: 0.45, encours: 3741, morningstar: null, sri: 3, replication: 'Physique',
  ...
  /* ---------------- OBLIGATIONS GLOBALES COUVERTES ---------------- */
  {
    ...
    ter: 0.10, encours: 2499, morningstar: null, sri: 3, replication: 'Physique',
    devise: 'EUR', hedge: true, capitalisation: true, isr: false,
    pea: false, enveloppes: ['AV', 'CTO'], contratsAV: ['av-standard'], verifie: false,
    donneesLe: '2026-08-15', donneesSource: 'justETF'
  },
  ...
  /* ---------------- IMMOBILIER COTÉ ---------------- */
  {
    ...
    ter: 0.59, encours: 1038, morningstar: null, sri: 5, replication: 'Physique',
    devise: 'USD', hedge: false, capitalisation: false, isr: false,
    pea: false, enveloppes: ['AV', 'CTO'], contratsAV: ['av-standard'], verifie: false,
    donneesLe: '2026-08-15', donneesSource: 'justETF'
  },
  {
    ...
    ter: 0.24, encours: 401, morningstar: null, sri: 5, replication: 'Physique',
    devise: 'EUR', hedge: false, capitalisation: true, isr: false,
    pea: false, enveloppes: ['AV', 'CTO'], contratsAV: ['av-large'], verifie: false,
    donneesLe: '2026-08-15', donneesSource: 'justETF'
  },
